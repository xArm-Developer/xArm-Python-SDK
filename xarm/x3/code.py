...
class APIState(object):
    ...
    LINEAR_MOTOR_HAS_FAULT = 80  # 滑轨有错误
    LINEAR_MOTOR_SCI_IS_LOW = 81  # 滑轨的SCI被置低了
    LINEAR_MOTOR_NOT_INIT = 82  # 直线滑轨未初始化
    LINEAR_TRACK_HAS_FAULT = LINEAR_MOTOR_HAS_FAULT
    LINEAR_TRACK_SCI_IS_LOW = LINEAR_MOTOR_SCI_IS_LOW
    LINEAR_TRACK_NOT_INIT = LINEAR_MOTOR_NOT_INIT
