...
arm.set_position(x=300, y=0, z=150, roll=180, pitch=0, yaw=50, speed=100, is_radian=False, wait=True)
print(arm.get_position(is_radian=False))
arm.set_position(x=300, y=200, z=250, roll=180, pitch=0, yaw=100, speed=200, is_radian=False, wait=True)
print(arm.get_position(is_radian=False))
