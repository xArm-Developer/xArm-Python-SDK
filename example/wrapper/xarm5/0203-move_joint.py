...
arm.set_servo_angle(angle=[math.radians(60), 0, 0, 0, 0], speed=speed, is_radian=True, wait=True)
print(arm.get_servo_angle(is_radian=True))
arm.set_servo_angle(angle=[math.radians(60), math.radians(-45), 0, 0, 0], speed=speed, is_radian=True, wait=True)
print(arm.get_servo_angle(is_radian=True))
arm.set_servo_angle(angle=[math.radians(60), math.radians(-45), 0, math.radians(-60), 0], speed=speed, is_radian=True, wait=True)
print(arm.get_servo_angle(is_radian=True))
...
print(arm.get_servo_angle(is_radian=True))
arm.set_servo_angle(angle=[math.radians(-45), math.radians(-45), 0, 0, 0], speed=speed, is_radian=True, wait=True)
print(arm.get_servo_angle(is_radian=True))
