...
arm.set_servo_angle(angle=[60, -60, 0, 0, 0, 0, 0], speed=30, is_radian=False, wait=True)
print(arm.get_servo_angle(is_radian=False))
arm.set_servo_angle(angle=[45, -60, -30, 0, 0, 0, 0], speed=30, is_radian=False, wait=True)
print(arm.get_servo_angle(is_radian=False))
