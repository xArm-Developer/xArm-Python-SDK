...
class LinearMotor(GPIO):
    ...
    def _get_linear_motor_registers(self, addr, number_of_registers=1):
        ...
        ret[0] = self._check_modbus_code(ret, length=5 + 2 * number_of_registers, host_id=XCONF.CONTROL_BOX_RS485_HOST_ID)
        return ret[0], ret[1:]
    ...
    def get_linear_motor_version(self):
        ...
        ret1[0] = self._check_modbus_code(ret1, length=7, host_id=XCONF.CONTROL_BOX_RS485_HOST_ID)
        ret2[0] = self._check_modbus_code(ret2, length=7, host_id=XCONF.CONTROL_BOX_RS485_HOST_ID)
        ret3[0] = self._check_modbus_code(ret3, length=7, host_id=XCONF.CONTROL_BOX_RS485_HOST_ID)
    ...
    def get_linear_motor_sn(self):
        ...
        for i in range(0, 14):
            ...
            ret[0] = self._check_modbus_code(ret, length=7, host_id=XCONF.CONTROL_BOX_RS485_HOST_ID)
