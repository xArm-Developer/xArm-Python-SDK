...
arm.set_servo_angle(angle=[math.radians(60), 0, 0, 0, 0, 0, 0], speed=speed, wait=True)
print(arm.get_servo_angle())
arm.set_servo_angle(angle=[math.radians(60), math.radians(-45), 0, 0, 0, 0, 0], speed=speed, wait=True)
print(arm.get_servo_angle())
arm.set_servo_angle(angle=[math.radians(60), math.radians(-45), 0, math.radians(-60), 0, 0, 0], speed=speed, wait=True)
print(arm.get_servo_angle())
...
print(arm.get_servo_angle())
arm.set_servo_angle(angle=[math.radians(-45), math.radians(-45), 0, 0, 0, 0, 0], speed=speed, wait=True)
print(arm.get_servo_angle())
