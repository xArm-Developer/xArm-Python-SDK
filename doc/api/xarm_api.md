...
#### def __set_bio_gripper_position__(self, pos, speed=0, force=50, wait=True, timeout=5, **kwargs):
...
#### def __set_gripper_g2_position__(self, pos, speed=2000, force=50, wait=False, timeout=None, **kwargs):
