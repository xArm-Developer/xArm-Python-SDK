...
arm.set_ft_sensor_force_parameters([Kp]*6, [Ki]*6, [Kd]*6, [linear_v_max, linear_v_max, linear_v_max, rot_v_max, rot_v_max, rot_v_max])
...
code = arm.set_ft_sensor_force_parameters(ref_frame,  force_axis, force_ref, [0]*6) # limits are reserved, just give zeros
